...
<html>
    ...
    <body>
        <div>
            ...
            <p>
                <button onclick="executarExemplo02(event)">Exemplo 02 - Variáveis</button>
            </p>
            
            <p>
                <button onclick="executarExemplo03(event)">Exemplo 03 - Condicionais</button>
            </p>
            
            <p>
                <button onclick="executarExemplo04(event)">Exemplo 04 - Repetição e Arrays</button>
            </p>
        ...
        <div>
            ...
            <div>
                <p>
                    <button onclick="executarExemplo07(event)">Exemplo 07 - jQuery</button>
                </p>
            ...
            <div>
                ...
                <div id="divExemplo08" class="divExemplo">
                    ...
                    <form id="form08">
                        ...
                        Campo 1:
                        <input id="campo01" type="text" name="campo01" value="valor campo 01"/>
                        <br>
                        
                        Campo 2:
                        <input id="campo02" type="text" name="campo02" value="valor campo 02"/>
                        <br>
                        ...
                        Área 5:
                        <textarea id="area05" name="area05" rows="5" cols="10">valor da área de texto 05</textarea>
                    </form>
                    <hr>
                    <button onclick="lerDadosFormulario(event)">Ler dados</button> 
                    <button onclick="lerDadosFormularioJQuery(event)">Ler dados jQuery</button>
                    <hr>
                    <button onclick="inserirDadosFormulario(event)">Inserir dados</button>
                    <button onclick="inserirDadosFormularioJQuery(event)">Inserir dados jQuery</button>
                    <hr>
                    <button onclick="inserirNovaOpcao(event)">Inserir nova opção (Select 03)</button>
                    <button onclick="inserirNovaOpcaoJQuery(event)">Inserir nova opção jQuery (Select 04)</button>
                    <hr>
                </div>
            </div>
            -->
            <div>
                ...
                <div id="divExemplo09" class="divExemplo">
                    Campo (digite algo e veja o console): <input id="campoExemplo09"/>
                    <br>
            ...
            <div>
                ...
                <div id="divExemplo10" class="divExemplo">
                    <canvas id="canvasExemplo10" height="260" width="550" class="canvasExemplo10"/>
                </div>
